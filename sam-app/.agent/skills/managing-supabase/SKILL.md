...
| `planilla_revisiones` | celdas (operario×día) marcadas como revisadas en la Planilla: `id`, `operador_id`, `fecha`, `revisado_por`, UNIQUE(`operador_id`,`fecha`) (mig. `20260615140000`) |
