...
function AppContent() {
  ...
  // (1–15 → Q1, 16–fin → Q2). Sin persistencia ni memoria de la última
  // selección (decisión del dueño 2026-06-24) — cada apertura arranca en el
  // corte vigente. El operario puede cambiarlo manualmente dentro de la sesión.
  ...
  const [historyPeriod, setHistoryPeriod] = useState<'Q1' | 'Q2' | 'MES'>(() =>
    currentQuincena(new Date().toLocaleDateString('en-CA', { timeZone: 'America/Bogota' })) === 'SEGUNDA'
      ? 'Q2'
      : 'Q1',
  )
