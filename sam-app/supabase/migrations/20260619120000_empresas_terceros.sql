...
--   terceros  = catálogo informativo de ingenios y terceros (clientes a los
--               que se les presta la labor). Los ingenios existentes se
--               siembran automáticamente y se pueden crear más a mano. Es una
--               lista de referencia: NO condiciona la operación ni se enlaza a
--               las suertes (decisión del usuario 21-jun-2026).
--
